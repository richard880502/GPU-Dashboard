...
type GPUData struct {
	...
	Temperature float64            `json:"t,omitempty,omitzero" cbor:"7,keyasint,omitempty,omitzero"`
	...
	// Processes lists what's currently using this GPU (gpu-monitoring fork
	// addition, not upstream), including plain host processes (Container
	// is "host" when a PID isn't inside a Docker container).
	Processes []GPUProcess `json:"procs,omitempty" cbor:"8,keyasint,omitempty"`
}

// GPUProcess is a gpu-monitoring fork addition: one process currently using
// a GPU, with the Docker container it runs in ("host" if none), matching
// this project's own gpu-process-exporter's PID->container attribution.
type GPUProcess struct {
	PID           string  `json:"pid" cbor:"0,keyasint"`
	Container     string  `json:"c" cbor:"1,keyasint"`
	MemoryMiB     float64 `json:"mu,omitempty,omitzero" cbor:"2,keyasint,omitempty,omitzero"`
	UtilPercent   float64 `json:"u,omitempty,omitzero" cbor:"3,keyasint,omitempty,omitzero"`
	MemoryPercent float64 `json:"mp,omitempty,omitzero" cbor:"4,keyasint,omitempty,omitzero"`
	Username      string  `json:"un,omitempty,omitzero" cbor:"5,keyasint,omitempty,omitzero"`
}
